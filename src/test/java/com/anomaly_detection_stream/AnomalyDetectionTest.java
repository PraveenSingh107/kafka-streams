...
public class AnomalyDetectionTest {
    ...
    public void shouldDetectAnomalousUser() throws Exception {
        ...
        useClickConsumerConfig.put(
                ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG,
                UserClickDeserializer.class.getName());

        List<ConsumerRecord<String, UserClick>> useClickRecords = GenericConsumer.consumeRecords(
                Topics.USER_CLICK_TOPIC,
                useClickConsumerConfig, 10);
        ...
        List<ConsumerRecord<String, Long>> numberOfClicksPerUser = GenericConsumer.consumeRecords(
                Topics.CLICK_COUNT, props,
                3);
